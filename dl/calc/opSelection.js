var original = '    <h1 style="display: flex; justify-content: center; font-weight: bold;">Selecciona el tipo de operación:</h1><div id="selector" style="display: flex; justify-content: center; padding: 10px; margin: 10px;"><input type="button" value="Suma" onclick="selectSuma()"><input type="button" value="Resta" onclick="selectResta()"><input type="button" value="Multiplicacion" onclick="selectMultiply()"></div><hr />'
